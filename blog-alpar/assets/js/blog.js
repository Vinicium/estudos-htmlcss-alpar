...
const menuElem = document.getElementById("as");
const menubutonElem = document.querySelector("header #botao")
...
},
{
    ...
    content: ` <figure>
          <img src="assets/images/rede.webp"
...
postElem.innerHTML = post.content;
    ...
    articleElem.appendChild(postElem);
...
/* menubutonElem.onclick = () =>
{

    menuElem.style.display = "flex";
}  */

    menubutonElem.addEventListener("click",() => {
